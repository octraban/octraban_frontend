    ...
    >
      ...
      <div>
        ...
        <div style={{ fontSize: "0.875em", opacity: 0.85 }}>
          This transaction was rejected because the block&apos;s total resource
          budget was exhausted (<code>tx_resource_limit_exceeded</code>). Try
          resubmitting in the next ledger when capacity resets.
        </div>
        {payload.tx_hash && (
          <div
            style={{
